<template>
  <div class="mark">
    <div id="mark-top">
      ...
      <mark>共有数据：101</mark>
      <div id="mark-btn">
        <el-button type="primary" icon="el-icon-circle-plus-outline" @click="dialogVisible = true">添加市场中心会员行业分类</el-button>
      </div>
    </div>
    <el-table :data="tableData" border style="width: 100%">
      ...
      <el-table-column prop="date" label="分类级别"></el-table-column>
