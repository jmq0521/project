  ...
  <div class="mrech">
     <div id="mrech-top">
        ...
        <div id="mrech-form">
          ...
          <div class="classify">
            <span>来源：</span>
            <input type="text" placeholder="输入金额来源"/>
          </div>
          <div class="classify">
            <span>订单号：</span>
    ...
    <el-table  border style="width: 100%">
      <el-table-column prop="date" label="商家ID" width="100px"></el-table-column>
      <el-table-column prop="name" label="商家名称" width="300px"></el-table-column>
      <el-table-column prop="date" label="交易类型"></el-table-column>
      <el-table-column prop="name" label="交易金额"></el-table-column>
      <el-table-column prop="date" label="余额"></el-table-column>
      <el-table-column prop="name" label="来源" width="300px"></el-table-column>
      <el-table-column prop="date" label="备注" width="300px"></el-table-column>
...
#mrech-form .classify:nth-of-type(4){margin-left: 0;}
